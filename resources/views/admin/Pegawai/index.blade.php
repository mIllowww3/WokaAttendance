    ...
    <div class="card shadow border-0">
        ...
        <div class="card-body">
            ...
            <form method="GET" class="mb-4">
                <div class="d-flex">
                    <input type="text" name="cari" class="form-control me-3" placeholder="Cari Pegawai..."
                        value="{{ request('cari') }}">
                    <button class="btn btn-primary" type="submit"><i class="fa fa-search"></i></button>
                    <a href="{{ route('admin.pegawai.index') }}" class="btn btn-primary ms-2"><i class="fa fa-refresh"></i></a>
                </div>
            </form>
