                ...
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder">52 Pegawai</h5>
                            <p class="mb-0">
                                <span class="text-success text-sm font-weight-bolder">+6%</span> dari kemarin
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder">7 Pegawai</h5>
                            <p class="mb-0">
                                <span class="text-danger text-sm font-weight-bolder">+3%</span> minggu ini
                            </p>
                        </div>
                    </div>
                    <div class="col-4 text-end">
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder">12 Pegawai</h5>
                            <p class="mb-0">
                                <span class="text-warning text-sm font-weight-bolder">Hari ini</span>
                            </p>
                        </div>
                    </div>
                    <div class="col-4 text-end">
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder">61 Scan</h5>
                            <p class="mb-0">
                                <span class="text-success text-sm font-weight-bolder">+10%</span> minggu ini
                            </p>
                        </div>
                    </div>
                    <div class="col-4 text-end">
